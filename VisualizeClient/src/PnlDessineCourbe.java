...
public class PnlDessineCourbe extends JPanel implements MouseMotionListener {
	...
	private boolean blCapteurAnalogique; 
	...
	public void paintComponent(Graphics g){
		...
		if (blCapteurAnalogique) g.drawLine(x, y, x1, y1);
...
//		seuilCentral = seuilBas + ((seuilHaut - seuilBas) / 2);
		...
		if (blCapteurAnalogique) g.drawString(affInfo, x, y);
	...
	/**
	 * @return the blCapteurAnalogique
	 */
	public boolean isBlCapteurAnalogique() {
		return blCapteurAnalogique;
	}

	/**
	 * @param blCapteurAnalogique the blCapteurAnalogique to set
	 */
	public void setBlCapteurAnalogique(boolean blCapteurAnalogique) {
		this.blCapteurAnalogique = blCapteurAnalogique;
	}
} // Fin class
