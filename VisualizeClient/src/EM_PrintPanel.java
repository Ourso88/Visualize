...
public class EM_PrintPanel implements Printable {
    ...
    public EM_PrintPanel(JPanel panel)
    {
        documentTitle = "";
        this.panel = panel;
        initPrintablePanel();
...
//        g2d.drawString(documentTitle + " - [" + (pageIndex + 1) + "/" + totalNumPages + "]", 0, (int)pf.getImageableHeight() - 20);
        // Modification EM 10-12-2014
        g2d.drawString(documentTitle, 0, (int)pf.getImageableHeight() - 20);
        return 0;
    }
	...
	/**
	 * @return the showPrintZone
	 */
	public boolean isShowPrintZone() {
		return showPrintZone;
	}

	/**
	 * @param showPrintZone the showPrintZone to set
	 */
	public void setShowPrintZone(boolean showPrintZone) {
		this.showPrintZone = showPrintZone;
	}
